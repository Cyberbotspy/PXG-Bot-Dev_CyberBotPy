...
def sairjogo():
    ...
    #SAIR CHAR BUGADO (PUXA COR PAREDE PERTO)
    if pyautogui.pixelMatchesColor(821, 136, (211, 211, 211)) == True:

        print('##NÃO CONSEGUIR SAIR DO JOGO##')
...
def resposta():
    ...
    if chat == 0:
        ...
        if pyautogui.pixelMatchesColor(242, 682, (212, 212, 1)) or pyautogui.pixelMatchesColor(243, 676, (246, 246, 0)):
            ...
            #DESATIVA PROTEÇÃO PLAYER BATTLE
            pl = 4
...
def checagemplayer():
    ...
    if pyautogui.pixelMatchesColor(1183, 445, (7, 9, 12)):
        ...
        if pl == 5: 
            ...
            print('PLAYER TELA, ESPERANDO 1HR')
...
while True:
    ...
    #TEMPO SAIR CASO ESTIVER EM BATTLE
    #time.sleep(3)
