...
#PRECISA INICIAR PARTY PRIMEIRO
...
pescanet = 0
#VARIAVEL FUNÇÃO CHATBOT
escolha = 0
#VARIAVEL HELPCHATBOT
conversou = 0
#VARIAVEL TENTATIVA TRYs
tentativa = 0
...
def initpxg():
    ...
    #SE NAO ESTIVER EM PARTY INFORMA ERRO
...
def sairjogo():
    ...
    while pyautogui.pixelMatchesColor(821, 136, (211, 211, 211)):
...
def caiunet():
    ...
    #CHECAGEM COR X
    if pyautogui.pixelMatchesColor(821, 136, (211, 211, 211)):
...
def resposta():
    ...
    if chat == 0:
        ...
        if pyautogui.pixelMatchesColor(242, 682, (212, 212, 1)) or pyautogui.pixelMatchesColor(243, 676, (246, 246, 0)):
            ...
            #MANDA MENSAGEM PLAYER/GM TELA
            chatbot()

            #MANDAR OUTROS BOT SAIREM 1hr
            sairbot()
...
def checagemplayer():
    ...
    if pyautogui.pixelMatchesColor(1215, 510, (7, 9, 12)):
...
def chatbot():
    ...
    if pyautogui.locateCenterOnScreen('gm.png', confidence=0.8, region=REGCHAT):
        ...
        pyautogui.write('flws Support Member')
        time.sleep(0.2)
        pydirectinput.press('enter')
...
#FUNÇÃO MANDAR MSG BOTs SAIREM (PLAYER-TELA)
def sairbot():

    #CLICAR ICONE PARTY
    image = Image.open('party.png')
    imagelocation = pyautogui.locateCenterOnScreen(image, confidence=0.8, region=REGPV)
    ...
    #MANDA COMANDO PARA OS BOTS SAIREM 1HR
    pyautogui.write('TEXTO-NOTIFICA-BOTS')
    time.sleep(0.2)
    pydirectinput.press('enter')
...
while True:
    ...
    #VERIFICA SE TEM PLAYER NA TELA
    checagemplayer()
    ...
    for s in range(0, 3):
        ...
        if pyautogui.locateOnScreen('estrela-shiny.png', confidence=0.8, region=REGBAT):
            ...
            try:
                ...
                #CLICAR DIRETO NO SHINY (-25 pixels para clicar no meio)
                h = h - 25
